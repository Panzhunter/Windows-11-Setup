...
Function RemoveApps {
	...
	#Asus Specific
	"B9ECED6F.ScreenPadMaster" # Removes MyAsus 
...
function InstallApps {
    ...
    if ($?) { 
        ...
        $apps = @{
            ...
            # 'Python'='Python.Python.3' # Downloads the latest version of python. Not sure if it adds to path or pulls other packages
            'SQLite'='SQLite.SQLite'
            'SQL Lite DB Browswer'='DBBrowserForSQLite.DBBrowserForSQLite'
            ...
            'Sunshine'='LizardByte.Sunshine' # Open source moonlight
            'Controller Drivers for Sunshine'='ViGEm.ViGEmBus' # Controller Drivers for Sunshine
            ...
            'Draw.io'='9MVVSZK43QQW'   # Draw.io Diagrams
            'GIMP'='GIMP.GIMP'
        }
